...
@section('title', 'Rekap Laporan: Tenaga Surveyor dalam satu Wilayah')
@section('breadcrumb')
    <li class="breadcrumb-item active"><a title="Rekap Laporan: Tenaga Surveyor"> Rekap Laporan: Tenaga Surveyor dalam satu Wilayah</a></li>
@endsection
@push('css_stack')
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-center mb-0 text-uppercase">Laporan Tenaga Surveyor dalam satu Wilayah</h4>
                    </div>
                </div>

                @if ($show_select_dw)
                    <form class="col-4 p-0" action="{{ route("{$bkpmumkm_identifier}.backend.rekap_laporan.tenaga_surveyor") }}" method="GET">
...
@push('js_stack')
    ...
    <script>
        $(document).ready(function () {
            $('form#tenagaSurveyorDatatable').remove();
        });
    </script>
@endpush
