...
@section('layout')
    <div class="container-fluid">
        <div class="row">
            ...
            {!! form_import_single("{$bkpmumkm_identifier}.backend.umkm.survey_massive.import", plugins_asset('bkpmumkm', 'umkm/files/format-import-survey-umkm-observasi-massive.xlsx'), '', true) !!}
        </div>
    </div>
@endsection
@push('js_stack')
