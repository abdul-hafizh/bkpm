@php
    $responden = ($survey->survey_result && (isset($survey->survey_result->data)&&$survey->survey_result->data) && (isset($survey->survey_result->data['responden'])&&$survey->survey_result->data['responden']) ? $survey->survey_result->data['responden']: '');
@endphp
<div class="card">
    <div class="card-body">
