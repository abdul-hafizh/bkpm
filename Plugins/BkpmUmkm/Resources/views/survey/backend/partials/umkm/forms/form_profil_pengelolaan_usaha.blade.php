<div class="card">
    <div class="card-header">
        <h3 class="card-title font-weight-bold">2. Profil Pengelolaan Usaha</h3>
            ...
            <tr class="row">
                ...
                <td class="col-md-8 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 profil_pengelolaan_usaha_kepemilikan_lainnya d-none">
                            <input type="text" name="data[profil_pengelolaan_usaha][kepemilikan_lainnya]" value="{{ (isset($profil_pengelolaan_usaha['kepemilikan_lainnya'])?$profil_pengelolaan_usaha['kepemilikan_lainnya']:(isset($profil_pengelolaan_usaha['kepemilikan_lainya'])?$profil_pengelolaan_usaha['kepemilikan_lainya']:'')) }}" placeholder="Lainnya" class="form-control form-control-sm">
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr class="row">
                ...
                <td class="col-md-8 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 profil_pengelolaan_usaha_omzet_sebutkan d-none">
                            <input type="text" name="data[profil_pengelolaan_usaha][omzet_sebutkan]" value="{{ (isset($profil_pengelolaan_usaha['omzet_sebutkan'])?$profil_pengelolaan_usaha['omzet_sebutkan']:'') }}" placeholder="Sebutkan" class="form-control form-control-sm">
                        </div>
                    </div>
                </td>
            </tr>
