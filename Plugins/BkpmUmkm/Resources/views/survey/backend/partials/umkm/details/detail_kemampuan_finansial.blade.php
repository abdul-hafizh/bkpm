            ...
            <tr class="row">
                ...
                <td class="col-md-8 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-check">
                                <input type="checkbox" name="data[kemampuan_finansial][sumber_dana_untuk_produksi]" value="Lainnya" {{ (isset($kemampuan_finansial['sumber_dana_untuk_produksi'])&&(is_array($kemampuan_finansial['sumber_dana_untuk_produksi'])&&in_array('Lainnya', $kemampuan_finansial['sumber_dana_untuk_produksi'])) ? 'checked':'') }} cl class="form-check-input" id="kemampuan_finansial_sumber_dana_untuk_produksi_5">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 kemampuan_finansial_sumber_dana_untuk_produksi_lainnya d-none">
                            {{ (isset($kemampuan_finansial['sumber_dana_untuk_produksi_lainnya'])?$kemampuan_finansial['sumber_dana_untuk_produksi_lainnya']:'') }}
                        </div>
                    </div>
                </td>
            </tr>
