$(function (e) {
    $(document).ready(function () {
        ...
        $('#treeViewCategory').treeview({
            debug : false,
            data : dataTreeViewCategoryChecked
        });


        $(document).on('submit','#formPostAddEdit',function (e) {
            e.preventDefault();
            let url = $(this).attr('data-action'),
                params = $(this).serializeJSON(),
                dataTreeViewCategory = $('#treeViewCategory').treeview('selectedValues');
            if (params.content === "") {
            ...
            if(dataTreeViewCategory.length <=0){
                Swal.fire('Please select category.!');
                return false;
            }
            params.categories = dataTreeViewCategory;
        ...
        $(document).on('click','#btnPreview',function (e) {
            e.preventDefault();
            let selectorForm = '#formPostAddEdit',
