(function ($, DataTable) {
    ...
    $.extend(true, DataTable.defaults, {
        ...
        "dom": simple_cms.dataTableDom(),
        // "pagingType": "bootstrap4_extended",
        ...
        "language": { // language settings
            ...
            "processing": '<div class="dataTables_processing_content"><i class="fas fa-spinner fa-pulse"></i> Processing...</div>',
            "paginate": {
                "previous": "Prev",
                "next": "Next",
                "last": "Last",
    ...
    DataTable.ext.buttons.export = {
        ...
        className: 'buttons-export btn-sm btn-info',
    ...
    DataTable.ext.buttons.postCsvVisibleColumns = {
        ...
        attr: {
            title : 'Export to CSV (only visible columns)'
        },
    ...
    DataTable.ext.buttons.print = {
        className: 'buttons-print btn-sm btn-secondary',
    ...
    DataTable.ext.buttons.reset = {
        className: 'buttons-reset btn-sm btn-warning',
    ...
    DataTable.ext.buttons.reload = {
        className: 'buttons-reload btn-sm btn-success',
    ...
    DataTable.ext.buttons.create = {
        className: 'buttons-create btn-sm btn-primary',
