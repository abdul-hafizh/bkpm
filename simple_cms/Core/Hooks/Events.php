...
class Events
{
     ...
     *
     * @var \SimpleCMS\Core\Hooks\Action
     */
    protected $action;
     ...
     *
     * @var \SimpleCMS\Core\Hooks\Filter
     */
    protected $filter;
     ...
     *
     * @return \SimpleCMS\Core\Hooks\Action
     */
     ...
     * Get the action instance.
     *
     * @return \SimpleCMS\Core\Hooks\Filter
     */
    ...
    public function action()
    {
        ...
        if(isset($args[0])){
            ...
            // return $this->action->fire(array_shift($args), $args);
        }
    }
    ...
    public function filter()
    {
        ...
        if(isset($args[0])){
            ...
            // return $this->filter->fire(array_shift($args), $args);
        }
    }
}
