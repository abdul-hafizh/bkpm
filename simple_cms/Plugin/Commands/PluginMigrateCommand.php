...
class PluginMigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'simple_cms:plugin:migrate';
     ...
     * @var string
     */
    protected $description = 'Runs the migrations for the given plugin.';
    ...
    public function handle()
    {
        ...
        $this->call('migrate', $this->getParameters($plugin));
    }
    ...
    protected function getParameters(Plugin $plugin)
    {
        ...
        $params['--path'] = str_replace(base_path(), '', $plugin->getPath());
