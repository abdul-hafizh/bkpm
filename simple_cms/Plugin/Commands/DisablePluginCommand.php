...
class DisablePluginCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'simple_cms:plugin:disable';
     ...
     * @var string
     */
    protected $description = 'Disables the specified plugin.';
    ...
    public function handle()
    {
        ...
        if (!$plugin->isEnabled())
            return $this->error("The [$name] plugin is already disabled.");

        $plugin->disable();

        $this->info("The [$name] plugin has been disabled.");
    }
