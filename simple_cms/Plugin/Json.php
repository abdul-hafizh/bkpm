...
use SimpleCMS\Plugin\Exceptions\InvalidJsonException;
...
class Json
{
    ...
    public function getAttributes()
    {
        ...
        if (config('plugin.plugins.cache.enabled') === false) {
            return $attributes;
        }

        return app('cache')->remember($this->getPath(), config('plugin.plugins.cache.lifetime'), function () use ($attributes) {
            return $attributes;
        });
    }
