...
class LanguageRepository extends Repository
{
     ...
     *
     * @var \SimpleCMS\Translation\Models\Language
     */
    protected $model;
    ...
    /**
     *  Constructor
     *  @param  \SimpleCMS\Translation\Models\Language      $model  Bade model for queries.
    ...
    public function __construct(Language $model, Application $app)
    {
        ...
        $config                        = $app['config'];
        $this->defaultLocale           = simple_cms_setting('locale', $config->get('app.locale'));;
