...
use SimpleCMS\Theme\Exceptions\UnknownLayoutFileException;
use SimpleCMS\Theme\Exceptions\UnknownPartialFileException;
use SimpleCMS\Theme\Exceptions\UnknownThemeException;
use SimpleCMS\Theme\Exceptions\UnknownWidgetClassException;
use Symfony\Component\HttpFoundation\Cookie;
use SimpleCMS\Theme\Contracts\Theme as ThemeContract;
...
class Theme implements ThemeContract
{
     ...
     * Breadcrumb.
     *
     * @var \SimpleCMS\Theme\Breadcrumb
     */
     ...
     * @param  \SimpleCMS\Theme\asset $asset
     * @param  \Illuminate\Filesystem\Filesystem $files
     * @param  \SimpleCMS\Theme\Breadcrumb|\SimpleCMS\Theme\Breadcrumb $breadcrumb
     * @param  \SimpleCMS\Theme\Manifest $manifest
     *
...
//        $path = $this->path(null);
    ...
    /**
     * Get current theme default from database / config.
     *
     * @return string
     */
    public function themeDefault()
    {
        return $this->getConfig('themeDefault');
    }
    /**
    ...
    {
        return $this->theme($this->theme)->info('slug');
    }
...
//            throw new UnknownThemeException("Theme [$theme] not found.");
        ...
        $this->asset->addPath($this->asset_path());
    ...
    public function path($forceThemeName = null)
    {
        ...
        if ($forceThemeName != false OR $forceThemeName != null OR !empty($forceThemeName) ) {
    ...
    public function asset_path()
    {
        ...
        return \Str::slug($themeDir,'-').'/'.$theme;
    }
     ...
     *
     * @return \SimpleCMS\Theme\Breadcrumb
     */
