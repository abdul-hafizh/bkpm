...
namespace SimpleCMS\EloquentViewable\Support;

use Carbon\Carbon;
use DateTime;
use Illuminate\Support\Str;
use SimpleCMS\EloquentViewable\Exceptions\InvalidPeriod;
...
class Period
{
     ...
     * @return \SimpleCMS\EloquentViewable\Support\Period
     */
     ...
     * @param  string  $subType
     * @param  int  $subValue
     * @return \SimpleCMS\EloquentViewable\Support\Period|null
     */
