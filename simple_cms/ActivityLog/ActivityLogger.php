...
use SimpleCMS\ActivityLog\Exceptions\CouldNotLogActivity;
...
class ActivityLogger
{
    ...
    /** @var \SimpleCMS\ActivityLog\ActivityLogStatus */
    protected $logStatus;

    /** @var \SimpleCMS\ActivityLog\Contracts\Activity */
    protected $activity;
    ...
    public function withUserRequests($requests)
    {
        $this->getActivity()->user_requests = collect($requests);
    ...
    {
        $this->getActivity()->group = $groupName;

        return $this;
    }
    public function onGroup(string $groupName)
    {
